...
const PaymentHeader = () => {
  return (
    <Card className="w-full px-3 rounded-md border mt-3 mb-5 py-3">
      ...
      <h3 className="text-base pb-1 text-center pt-2 font-medium tracking-tighter md:text-lg ">Se você está nessa página, pressupomos que você já fez o seu cadastro anteriormente mas NÃO realizou o pagamento.</h3>
